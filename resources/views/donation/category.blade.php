...
@section('main', 'Category Management')
@section('link')
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="second">
                                                                    <a class="btn text-center"
                                                                        href="{{ route('dashboard-donation-delete-category', $category->id) }}">Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="modal fade" id="addNewBus" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('dashboard-donation-add-category') }}" id="addBusForm" method="POST">
                                @csrf
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-3">
