                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-center h-px">
                        <form class="w-px-500 border rounded p-3 p-md-5" method="POST" action="{{ Request::url() }}"
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-12 col-form-label" for="form-alignment-username">Number of verse</label>
                                <div class="col-sm-12">
                                    <input type="number" required name="verse" id="" class="form-control"
                                ...
                                <div class="col-sm-12">
                                    <select id="defaultSelect" class="form-select" name="type" required >
                                        <option selected value="" disabled>Select Type</option>
                                            ...
                                            <option value="MEDINIAN">MEDINIAN</option>
                                    </select>
                                </div>
                            </div>
