...
@section('main', 'Hadiths Books Management')
@section('link')
                        ...
                        <div class="">
                            <button class="btn btn-secondary add-new btn-primary" tabindex="0"
                                ...
                                data-bs-target="#addNewBus"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                        class="d-none d-sm-inline-block">Add New Book</span></span></button>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <a href="{{ route('dashboard-hadith-subcategory' , $category->id) }}"
                                                class="text-body delete-record">
                                                <i class="ti ti-eye x`ti-sm mx-2"></i>
                                            </a>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                                    <div class="modal-content deleteModal verifymodal">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="body">After deleting the Book user cannot see this</div>
                                                        </div>
                                                        <hr class="hr">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="second">
                                                                    <a class="btn text-center"
                                                                        href="{{ route('dashboard-hadith-delete-category', $category->id) }}">Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="modal fade" id="addNewBus" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('dashboard-hadith-add-category') }}" id="addBusForm" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-3">
                                            <label for="nameWithTitle" class="form-label">Book</label>
