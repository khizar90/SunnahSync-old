            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between">
                        <h5 class="card-title mb-3">Dua Categories List</h5>
                        <div class="">
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <a href="{{ route('dashboard-dua-subCategory' , $category->id) }}"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="second">
                                                                    <a class="btn text-center"
                                                                        href="{{ route('dashboard-dua-delete-category', $category->id) }}">Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="modal fade" id="addNewBus" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('dashboard-dua-add-category') }}" id="addBusForm" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-3">
