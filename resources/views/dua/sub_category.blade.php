...
@section('main', 'Dua Category Management')
@section('link')
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between">
                        <h5 class="card-title mb-3">Dua Sub Categories List</h5>
                        <div class="">
                            <button class="btn btn-secondary add-new btn-primary" tabindex="0"
                                ...
                                data-bs-target="#addNewBus"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                        class="d-none d-sm-inline-block">Add New Sub Category</span></span></button>
                        </div>
                    </div>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            ...
                                            <div class="dt-buttons btn-group flex-wrap">
                                                ...
                                                data-bs-target="#addNewdua{{ $category->id }}" class="btn btn-primary"><span><i
                                                            class="ti ti-plus me-0 me-sm-1 ti-xs"></i></a>
                                                {{-- <span
                                                            class="d-none d-sm-inline-block"></span>Add new Dua</span> --}}

                                            </div>

                                            <div class="modal fade" id="addNewdua{{ $category->id }}" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modalCenterTitle">Add New Sub
                                                                Category</h5>
                                                        </div>
                                                        <form action="{{ route('dashboard-dua-add') }}"
                                                            id="addBusForm" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <input type="text" hidden name="category_id" id="" value="{{ $category->category->id }}">
                                                                <input type="text" hidden name="sub_category_id" id="" value="{{ $category->id }}">
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        <label for="nameWithTitle" class="form-label">Image</label>
                                                                        <input class="form-control" required name="images[]" type="file"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="second">
                                                                    <a class="btn text-center"
                                                                        href="{{ route('dashboard-dua-delete-subCategory', $category->id) }}">Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="modal fade" id="addNewBus" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Add New Sub Category</h5>
                            </div>
                            <form action="{{ route('dashboard-dua-add-subCategory') }}" id="addBusForm" method="POST">
                                @csrf
                                <div class="modal-body">
                                    <div class="row mb-3">
                                        <label class="col-sm-12 col-form-label"
                                            for="form-alignment-username">Category</label>
                                        <div class="col-sm-12">
